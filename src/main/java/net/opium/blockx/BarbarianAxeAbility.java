...
public class BarbarianAxeAbility {
    ...
    public void startCharging(Player player) {
        ...
        BukkitTask task = new BukkitRunnable() {
            ...
            public void run() {
                ...
                player.getWorld().spawnParticle(Particle.CRIT_MAGIC, particleLoc, 5, 0.4, 0.4, 0.4, 0.05);
                player.getWorld().spawnParticle(Particle.FLAME, particleLoc, 2, 0.3, 0.3, 0.3, 0.02);
            }
    ...
    private void triggerAbility(Player player, Location targetLocation) {
        ...
        world.spawnParticle(Particle.EXPLOSION_HUGE, targetLocation.clone().add(0.5, 0.5, 0.5), 1); // Main explosion particle
        world.spawnParticle(Particle.LAVA, targetLocation.clone().add(0.5, 0.5, 0.5), 8, 0.5, 0.5, 0.5, 0.1); // Some lava/fire particles
        world.spawnParticle(Particle.SMOKE_LARGE, targetLocation.clone().add(0.5, 0.5, 0.5), 10, 0.7, 0.7, 0.7, 0.05); // Smoke
        ...
        for (Block blockToBreak : nearbyBlocks) {
            ...
            world.spawnParticle(Particle.BLOCK_CRACK, blockToBreak.getLocation().clone().add(0.5, 0.5, 0.5), 20, blockToBreak.getBlockData());
